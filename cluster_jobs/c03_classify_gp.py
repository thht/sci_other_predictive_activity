...
class ClassifyGPJob(Job):
    def shall_run(self, subject_id: str, fold_fun: str, remove_overlap: bool):
        path_results = 'data_nogit/results_classify_gp'
    ...
    def run(self, subject_id: str, fold_fun: str, remove_overlap: bool):
        ...
        rows = [ dict(zip(['subj','block','cond','path'], v[:-15].split('_')[:-2] + [v])  ) for v in os.listdir(path_data)]
